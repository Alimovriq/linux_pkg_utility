...
def comparator(first_branch_pkg: dict, second_branch_pkg: dict,
    ...
    result_data = {
            ...
            f"{first_branch_name}_version_releases": []
    }

    first_branch_archs = set(first_branch_pkg.keys())
    second_branch_archs = set(second_branch_pkg.keys())

    # ToDo 1. архитектуры только в first_branch
    # ToDo 2. архитектуры только в second_branch
    ...
    for arch in archs_all_branches:
        ...
        only_first_branch_pkgs = [s for s in second_branch_pkg[arch] if s["name"] in only_second_branch_pkg_names]
        result_data["only_in_p11"].extend(only_first_branch_pkgs)
        ...
        result_data["only_in_sisyphus"].extend(only_first_branch_pkgs)
        ...
        rpm_compare(all_branches_pkg_names, result_data, f"{first_branch_pkg}_version_releases",
